...
### :material-account-school: Learning & Instructional Design
...
### :lucide-briefcase: Industry Experience
...
### :lucide-graduation-cap: Publishing Studies and Content Strategy

**Master of Arts** | **Bachelor of Arts** | *2011 — 2018*<br>
...
### :lucide-graduation-cap: Methods and Techniques of Teaching Online
...
## :lucide-presentation: Professional Development

### Communication & Soft Skills

!!! success ""
    #### :lucide-heart-handshake: Emotional Intelligence
    *[Green Key](https://www.greenkeypersonaldevelopment.com/), 2018* | *Trainer-led course* <br>
    Focus: Recognizing the emotional state of others and reacting effectively in professional environments.

!!! success ""
    #### :lucide-mic-2: Master of the Word: Public Speaking & Training the Voice
    *[IGRO](https://www.igro.ru/kursy/khozyain-slova-masterstvo-publichnykh-vystupleniy-spb/) , 2017* | *Trainer-led course *<br>
...
!!! success ""
    #### :lucide-headset: Vocal Victories
    *[The Call Center School](https://www.thecallcenterschool.com), 2016* | *Online course and certification* <br>
    Focus: Active listening, Leading the conversation, Professional communication with emotional customers.

!!! success ""
    #### :lucide-users: Effective Service and Communication
    *Schouten Russia, 2015* | *Trainer-led course* <br>
...
!!! note ""
    #### :simple-confluence: Manage Confluence spaces to organize your team's work
    *Atlassian, 2026* | *Online Learning Path*<br>
    Focus: Managing Confluence settings, permissions and content

!!! note ""
    #### :simple-swagger: Basics of Documenting API
    *[Documentat.io](https://documentat.io/courses/api-documentation/), 2025* | *Trainer-led course* <br>
    Focus: API schema components, Postman, basics of CI/CD for managing static sites

!!! note ""
    #### :fontawesome-brands-openai: Advanced Features of ChatGPT
    *OpenAI (for Enterprise users), 2024* | *Trainer-led course* <br>
    Focus: Custom GPT, Using the Deep Research feature, Canvas, Troubleshooting

---

## :lucide-award: Exams & Technical Certifications

<div class="grid cards" markdown>

- :fontawesome-brands-google: **Google: The Bits and Bytes of Computer Networking**

    ---

    **Skills**: OSI Model, TCP/IP, DNS, Troubleshooting. <br>
    [:lucide-external-link: View Certificate](https://www.coursera.org/account/accomplishments/verify/QPBW23KVFL8R)

- :material-microsoft-outlook: **Microsoft Outlook Specialist**

    ---

    **Skills**: Information management, workflow organization. <br>
    [:lucide-external-link: View Certificate](https://www.certiport.com/portal/Pages/PrintTranscriptInfo.aspx?action=Cert&id=123&cvid=UZ2%209duO6p28yMWzEuOQRQ%3D%3D)

- :fontawesome-brands-google: **Google: Technical Support Fundamentals**

    ---

    **Skills**: Linux OS, CLI commands, Triage <br>
    [:lucide-external-link: View Certificate](https://www.coursera.org/account/accomplishments/verify/C5REA59WTJPX)
...
!!! abstract ""
    #### :simple-openstreetmap: **OpenStreetMap**
    Adding houses and points of interest to OpenStreetMap across Georgia, [documented](https://wiki.openstreetmap.org/wiki/WikiProject_Georgia_Abkhazia_South-Ossetia) the Georgian community naming conventions and data sources.
